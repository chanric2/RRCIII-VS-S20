...
Partial Class StansGroceryForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.StansGuideToolTip = New System.Windows.Forms.ToolTip(Me.components)
        ...
        Me.StansGuideToolTip.SetToolTip(Me.SearchTextBox, "Type An Item To Find In Store")
        '
        'ComboBox1
        '
        ...
        Me.StansGuideToolTip.SetToolTip(Me.ComboBox1, "Select Item To Buy")
        '
        'DisplayListBox
        '
